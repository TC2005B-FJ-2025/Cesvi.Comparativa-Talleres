      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Crafting digital experiences that blend simplicity with functionality.
              Our platform is designed to make your workflows elegant and efficient.
            </p>
        ...
        <div className="border-t border-border/60 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Elegance Software. All rights reserved.
          </p>
